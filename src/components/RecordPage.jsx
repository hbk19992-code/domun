...
const S = {
  ...
  shell: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 14, alignItems: 'start' },
  list: { background: 'rgba(15,23,42,0.58)', border: '1px solid #1e293b', borderRadius: 16, padding: 10, maxHeight: 560, overflowY: 'auto' },
  listItem: (active) => ({
  ...
  panel: { background: 'rgba(15,23,42,0.82)', border: '1px solid #1e293b', borderRadius: 18, overflow: 'hidden' },
  ...
  body: { padding: 18 },
  textarea: {
    width: '100%', boxSizing: 'border-box', minHeight: 230, resize: 'vertical',
